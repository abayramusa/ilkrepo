...
public class SimpleRestDemo {
    //client and database connects through API
//one database can have more than one api that does different jobs
    @Test
    public void test1() {
    ...
    @Test
    public void test2(){
        Response response=RestAssured.get("https://api.got.show/api/continents");
